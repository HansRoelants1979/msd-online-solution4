...
scriptLoader.load("Tc.Crm.Scripts.Events.Compensation", ["Tc.Crm.Scripts.Common", "Tc.Crm.Scripts.Library.Compensation"], function () {
    ...
    Tc.Crm.Scripts.Events.Compensation = (function () {
        ...
        var reopenCompensationButtonRibbonButtonEnabled = false;
        ...
        var refreshRibbon = function (userRoleId) {
            try {
                //refresh ribbon after user role is retrieved
                //and Status reason is whether PaymentProcessed or ComebackPaymentProcessed
                if (!ribbonButtonRefreshed) {
                    ...
                    Tc.Crm.Scripts.Common.GetById(EntitySetNames.SecurityRole, userRoleId, query).then(
                        function (securityRoleNameResponse) {
                            ...
                            debugger;
                            if (role.name === SecurityRoles.SystemAdministrator || role.name === SecurityRoles.CustomerRelationsAgent ||
                                role.name === SecurityRoles.CustomerRelationsManager || role.name === SecurityRoles.SystemMaintenance) {
                                debugger;
                                reopenCompensationButtonRibbonButtonEnabled = isProcessedStatusReason();
        ...
        return {
            ...
            OnReopenCompensationButtonClick: function () {
